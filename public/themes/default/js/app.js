(function($){
    ...
    $('#popuptransdroid').popover(
    {
        html : true,
        trigger : 'hover',
        content : "Generuje plik konfiguracyjny dla aplikacji Transdroid.",
    ...
    $('.popup-delete-user').click( function()
    {
        ...
        $('#target-delete-user').html('<i class="glyphicon glyphicon-trash"></i> Usuwanie użytkownika : <strong>'+userName+'</strong>');
    });
